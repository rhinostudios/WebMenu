...
PIXI.Texture.fromImage('LB.png');
PIXI.Texture.fromImage('W.png');	//Slide around on B Bkgd;
for (var i=1,i<6,i++){
var W[i] = new PIXI.Sprite('W.png');}
var imgFrames = new Array('');//ALL IMGS FOR WEBSITE
setup();

function setup(){
	for (var i=0,i<32,i++){			//Img 6x6 grid
		PIXI.Texture.fromImage('Img[i].png');//Make var if necessary
		imgFrames[i]=new PIXI.Sprite('Img[i].png');}
	...
	W3.position.x = (gw/4)*2; W3.position.y = gh/2;
